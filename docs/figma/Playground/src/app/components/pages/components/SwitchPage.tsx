      ...
      <div className="max-w-5xl mx-auto px-12 py-24">
        <header className="mb-16 space-y-4">
          <div className="flex items-center gap-3 text-sm text-[rgba(241,241,241,0.6)]">
            ...
            <span>Moléculas</span>
            <span>/</span>
            <span className="text-[#F1F1F1]">Switch</span>
          </div>
          <h1 className="text-5xl font-black text-[#F1F1F1] leading-tight">Switch</h1>
          <p className="text-lg text-[rgba(241,241,241,0.7)] max-w-3xl leading-relaxed">
            Interruptor de toggle on/off para configuraciones binarias.
          </p>
        </header>
